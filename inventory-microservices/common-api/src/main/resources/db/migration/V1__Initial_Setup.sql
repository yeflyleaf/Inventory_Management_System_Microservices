...
-- Combined schema and data for automated initialization
...
-- 3. Nacos Tables (in same DB as configured in docker-compose)
...
INSERT IGNORE INTO item (sku, name, category, unit, sale_price) VALUES 
('IPHONE15', 'iPhone 15 128G', '手机', '部', 5999.00),
('MACBOOK_AIR', 'MacBook Air M2', '电脑', '台', 8999.00);

INSERT IGNORE INTO warehouse (name, address) VALUES 
('主仓库', '上海市浦东新区'),
('备用仓库', '北京市朝阳区');
